...
public class RegistrationControllerTest {
    ...
    public void createRegistrationTest() throws Exception {
        ...
        Registration savedRegistration = Registration.builder().id(101)
                .name("Bruna Guimaraes").dateOfRegistration("04/04/2022").registration("001").build();
    ...
    private RegistrationDTO createNewRegistration() {
        return  RegistrationDTO.builder().id(101).name("Bruna Guimaraes")
                .dateOfRegistration("04/04/2022").registration("001").build();
    }
