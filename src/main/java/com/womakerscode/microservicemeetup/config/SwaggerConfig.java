package com.womakerscode.microservicemeetup.config;
...
public class SwaggerConfig {
    ...
    public Docket docket() {
        return new Docket(DocumentationType.SWAGGER_2)
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.womakerscode.microservicemeetup.controller.resource"))
    ...
    private Contact contact() {
        return new Contact("Bruna Guimaraes de Barros Leal dos Santos",
                "https://github.com/Brunaguimaraesb",
                "brunaguimaraes.santos@hotmail.com");
    }
